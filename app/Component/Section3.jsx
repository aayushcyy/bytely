...
export default function Section3() {
  return (
    <div className="w-full xl:h-screen relative xl:px-60 sm:px-10 lg:px-[14vw] flex flex-col gap-16 lg:pb-20 xl:pb-0">
      <div className="flex flex-unwrap gap-8">
        <div className="flex flex-col">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-sm sm:text-xs text-[#626262]">
        ...
        <div className="gap-x-8 gap-y-5 flex flex-wrap w-full text-sm sm:text-xs">
          <div className="flex w-[27%] xl:gap-1 lg:gap-2 gap-2">
            <div className="sm:pt-0.5">
              <EyeIcon className="size-5 sm:size-4" color="#176164" />
            </div>
            <div className="flex flex-col font-medium gap-1.5">
              <p className="sm:text-sm">View tracking</p>
          ...
          <div className="flex w-[33.5%] xl:gap-1 lg:gap-2 gap-2">
            <div className="sm:pt-0.5">
              <EnvelopeIcon className="size-5 sm:size-4" color="#176164" />
            </div>
            <div className="flex flex-col font-medium gap-1.5">
              <p className="sm:text-sm">Mail merge</p>
              <p className="font-normal">
          ...
          <div className="flex w-[27%] xl:gap-1 lg:gap-2 gap-2">
            <div className="sm:pt-0.5">
              <ClockIcon className="size-5 sm:size-4" color="#176164" />
            </div>
            <div className="flex flex-col font-medium gap-1.5">
              <p className="sm:text-sm">Send later</p>
              <p className="font-normal">
          ...
          <div className="flex w-[27%] xl:gap-1 lg:gap-2 gap-2">
            <div className="sm:pt-0.5">
              <DocumentIcon className="size-5 sm:size-4" color="#176164" />
            </div>
            <div className="flex flex-col font-medium gap-1.5">
              <p className="sm:text-sm">Snippets</p>
              <p className="font-normal">
          ...
          <div className="flex w-[33.5%] xl:gap-1 lg:gap-2 gap-2">
            <div className="sm:pt-0.5">
              <ArrowsUpDownIcon className="size-5 sm:size-4" color="#176164" />
            </div>
            <div className="flex flex-col font-medium gap-1.5">
              <p className="sm:text-sm">Thread splitter</p>
              <p className="font-normal">
          ...
          <div>
            ...
            >
              Learn More{" "}
              <ArrowRightIcon className="size-5 sm:size-4" color="#176164" />
            </Link>
          </div>
        </div>
