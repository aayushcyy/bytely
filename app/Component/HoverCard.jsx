  ...
  return (
    <HoverCard>
      <HoverCardTrigger asChild>
        ...
        >
          <TriggerIcon className="xl:size-5 lg:size-4 sm:size-4 stroke-3 text-gray-500 group-hover:text-[#08514D] group-hover:stroke-4" />
          <p className="text-gray-500 group-hover:text-black xl:text-base lg:text-sm sm:text-xs">
            {triggerText}
          </p>
        </div>
      </HoverCardTrigger>
